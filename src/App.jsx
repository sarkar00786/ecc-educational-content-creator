  ...
  const handleExportToPDF = (contentToExport, fileName = "ECC-Export") => {
    ...
    if (typeof html2pdf === 'undefined') {
      toast({
        ...
        description: "PDF export library not loaded. Please refresh the page and try again.",
        status: "error",
        duration: 5000,
        isClosable: true,
      });
    ...
    if (!contentToExport || contentToExport.trim() === '') {
      toast({
        ...
        description: "Please generate some content before exporting to PDF.",
        status: "warning",
        duration: 3000,
        isClosable: true,
      });
      ...
      const htmlContent = `
        ...
        <html>
          ...
          <body>
            <div class="header">
              <h1>${fileName}</h1>
              <p>Generated by ECC App - Educational Content Creator</p>
            ...
            <div class="footer">
              <p>This document was created using ECC App - Educational Content Creator</p>
              <p>© ${new Date().getFullYear()} ECC App. All rights reserved.</p>
            </div>
          </body>
        </html>
      `;
