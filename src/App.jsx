...
toast({
  ...
  // PDF Export function (replicated from PublicViewer)
  const handleExportToPDF = (contentToExport, fileName = "ECC-Export") => {
    if (typeof html2pdf !== 'undefined' && contentToExport) {
      const htmlContent = `
        <html>
          <head>
            <style>
      ...
      toast({
        ...
        description: "PDF export is not available. Please try copying the content instead.",
        status: "error",
        duration: 5000,
        isClosable: true,
      });
